...
function CommentDetails({comment,userID}) {
  ...
  return (
    ...
    <div className={styles.comment}>
        ...
        <div className={styles.commentContent}>
             <div className={styles.commentHeader}> 
                ...
                {console.log(comment.timestamp)}
                 <time>{new Date(comment.timestamp * 1000).toLocaleString("ar-DZ",{
                    year:"numeric",
                    month:"long",
                    day:"2-digit",
                    hour:"2-digit",
            ...
            <p>{comment.content} </p>
             ...
             <button onClick={()=>{toggleResponse()}}>الرد</button>
             <button onClick={()=>{toggleReplies()}}>عرض الردود</button>
       </div>
     </div>
     ...
     {replies.map(reply => <CommentDetails comment={reply}/>)}
